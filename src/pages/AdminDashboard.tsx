          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="cursor-pointer hover:bg-gray-50 transition-colors">
              <CardContent className="pt-6 text-center">
                ...
                <h3 className="font-medium">Kelola Sesi</h3>
                <p className="text-sm text-gray-600">Buat dan atur sesi kajian</p>
              </CardContent>
            </Card>
            <Card className="cursor-pointer hover:bg-gray-50 transition-colors">
              <CardContent className="pt-6 text-center">
                <Users className="h-8 w-8 mx-auto mb-2 text-green-600" />
                <h3 className="font-medium">Kelola Peserta</h3>
                <p className="text-sm text-gray-600">Lihat dan atur peserta</p>
              </CardContent>
            </Card>
            <Card className="cursor-pointer hover:bg-gray-50 transition-colors">
              <CardContent className="pt-6 text-center">
                ...
                <p className="text-sm text-gray-600">Scan QR code peserta</p>
              </CardContent>
            </Card>
          </div>
        </CardContent>
